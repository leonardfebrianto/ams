        ...
        <!-- Container START -->
            <div id="colres">
                <div class="disp">';
                    ...
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query2);
                        ...
                        echo '<span id="alamat">Jl. Pluit Karang Cantik Blok B4 No. 39 Telp/Fax. (021) 2089208 Jakarta Utara 14450</span>';
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            <tr>
                                <td class="tgh" id="lbr" colspan="5">LEMBAR FILE</td>
                            </tr>
                            <tr>
            ...
            <div id="lead">
                ...
                if(!empty($kepsek)){
                    ...
                    echo '<p class="lead">Selvi Susanti</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIk. '.$nip.'</p>';
                } else {
