...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            if(!empty($data['logo'])){
                                ...
                                echo '<img class="logoside" src="./asset/img/kop_surat.png"/>';
                            }
                            if(!empty($data['nama'])){
                                echo '<h5 class="smk-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="smk-side">PT. Szeto Global Indonesia</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. Pluit Karang Cantik Blok. B4 Barat No. 39 Telp/Fax. (021) 260810256 Jakarta Utara 14450</p>';
                            }
                        }
                    ?>
                </div>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down">Szeto</a></li>
            <li><div class="grs"></></li>
            <li><a href="./"><i class="material-icons"></i>&nbsp; Beranda</a></li>
            <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3){ ?>
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Quatation<i class="material-icons md-18">arrow_drop_down</i></a></li>
                <ul id='transaksi' class='dropdown-content'>
                    <li><a href="?page=tsm">Quatation Rate</a></li>
                </ul>
            <?php
                }
            ?>
